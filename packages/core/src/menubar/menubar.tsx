...
export const MenubarGroup: React.FC<MenubarGroupProps> = MenubarPrimitive.Group;
...
export const MenubarRadioGroup: React.FC<MenubarRadioGroupProps> = MenubarPrimitive.RadioGroup;
...
export const MenubarSubTrigger = React.forwardRef<
  ...
  MenubarSubTriggerProps & { inset?: boolean }
...
export const MenubarItem = React.forwardRef<
  ...
  MenubarItemProps & { inset?: boolean }
...
export const MenubarLabel = React.forwardRef<
  ...
  MenubarLabelProps & { inset?: boolean }
>(({ className, inset, ...props }, ref) => (
