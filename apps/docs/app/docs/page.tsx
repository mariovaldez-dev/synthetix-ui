...
npx @synthetix-ui add input card dialog`}</code>
      ...
      <p>O instala el paquete completo como dependencia npm:</p>

      <pre>
        <code>{`npm install @synthetix-ui/core`}</code>
      </pre>
...
const COMPONENTS = [
  ...
  { href: "/docs/pagination", label: "Pagination", description: "Paginación con ellipsis" },
  { href: "/docs/avatar", label: "Avatar", description: "Avatar con imagen y fallback" },
  { href: "/docs/tabs", label: "Tabs", description: "Pestañas accesibles con Radix UI" },
];
